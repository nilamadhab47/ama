        ...
        <form className=' w-full'>
            <div className="namegroup flex justify-center gap-4 mb-6">
                <div className="first flex flex-col w-1/2">
                    ...
                    <input type="text" className="rounded-[5px] pt-[7px] pb-[7px] pl-[11px] pr-[11px] placeholder:text-xs" style={{border: "1px solid #e9ebed"}} placeholder="First Name" name="first name" />
                </div>
                <div className="last flex flex-col w-1/2">
                    ...
                    <input type="text" className="rounded-[5px] pt-[7px] pb-[7px] pl-[11px] pr-[11px] placeholder:text-xs" style={{border: "1px solid #e9ebed"}}  placeholder="Last Name" name="last name" />
                </div>
            </div>
            <div className="emailGroup flex flex-col mb-6">
                ...
                <input type="text" className=" w-full rounded-[5px] pt-[7px] pb-[7px] pl-[11px] pr-[11px] placeholder:text-xs" style={{border: "1px solid #e9ebed"}}  placeholder="Email" name="email" />
            </div>
            <div className="messageGroup flex flex-col">
                ...
                <textarea name="message" id="message" cols="10" rows="3" placeholder='Text Area' className=' w-full rounded-[5px] pl-2 pt-2 placeholder:text-xs' style={{border: "1px solid #e9ebed"}} />
            </div>
        </form>
